      ...
      <div className="App">
        <div className="App-header">
          ...
          <div className="social">
            ...
            <a href="https://github.com/rparanjothy">
              <i class="fab fa-github social-icon fa-2x" />
            </a>
        ...
        <div className="profile">
          <div className="experience">
            <Experience
              ...
              logo={thdlogo}
              title="Principal Consultant | March 2013 – current"
              ...
              • Transition legacy ETL modules into cloud native real-time applications by leveraging Google cloud storage, cloud functions (NodeJS), Redis, Postgres and Google pub/sub.
